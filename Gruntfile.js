// Generated on 2015-12-30 using generator-angular-fullstack 3.1.1
'use strict';
...
//            presets:['es2015']
    ...
    grunt.registerTask('serve', function (target) {
        if (target === 'dist') {
            return grunt.task.run(['build', 'env:all','forever:server1:start', 'env:prod', 'express:prod', 'wait', 'open', 'express-keepalive']);
        }
